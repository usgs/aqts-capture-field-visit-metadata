...
--           jsonb_extract_path(jsonb_array_elements(jsonb_extract_path(jd.json_content, 'FieldVisitReadings')), 'Uncertainty') as uncertainty,
          jsonb_array_elements(jsonb_extract_path(
              jsonb_extract_path(jd.json_content, 'FieldVisitReadingsResponse'), 'FieldVisitReadings')) as field_visit_readings,
          jsonb_extract_path(jsonb_array_elements(jsonb_extract_path(
              jsonb_extract_path(jd.json_content, 'FieldVisitReadingsResponse'), 'FieldVisitReadings')), 'Approval') as approval,
          jsonb_extract_path(jsonb_array_elements(jsonb_extract_path(
              jsonb_extract_path(jd.json_content, 'FieldVisitReadingsResponse'), 'FieldVisitReadings')), 'Uncertainty') as uncertainty,
          jd.partition_number,
